      ...
      <article className="w-full bg-[#0A192F] md:bg-slate-900/50 md:border border-slate-800 md:p-12 md:rounded-xl shadow-2xl print:bg-transparent print:border-none print:shadow-none print:p-0">
        ...
        <header className="border-b border-slate-800 pb-8 mb-8 print:border-slate-300">
          ...
          <div className="flex flex-wrap gap-x-6 gap-y-2 text-sm text-slate-400 font-mono print:text-slate-600">
            ...
            <a href="https://github.com/g-softtech" target="_blank" rel="noopener noreferrer" className="hover:text-[#D4AF37] transition-colors">GitHub ↗</a>
            <a href="https://cortex-systems-portfolio-frontend.vercel.app/" target="_blank" rel="noopener noreferrer" className="hover:text-[#D4AF37] transition-colors">Portfolio ↗</a>
            <a href="https://www.linkedin.com/in/gbemisola-jayeoba-17253576" target="_blank" rel="noopener noreferrer" className="hover:text-[#D4AF37] transition-colors">LinkedIn ↗</a>
            <a href="mailto:tosinjaiyeoba@yahoo.com" className="hover:text-[#D4AF37] transition-colors">Email ↗</a>
          </div>
        </header>
