    ...
    <main className="grow flex flex-col items-center justify-start pb-24 w-full">
      ...
      <section id="experience" aria-labelledby="experience-heading" className="w-full max-w-6xl px-6 md:px-8 py-16 border-t border-slate-200 dark:border-slate-800/50">
        ...
        <div className="flex flex-col gap-8">
          <div className="p-8 border border-slate-200 dark:border-slate-800 bg-white/50 dark:bg-[#0A192F]/50 rounded-xl backdrop-blur-sm relative hover:border-slate-300 dark:hover:border-slate-700 transition-colors group">
            <div className="flex flex-col md:flex-row md:items-center justify-between mb-6 gap-4">
              <div>
                <h4 className="text-2xl font-bold text-slate-900 dark:text-white mb-1">Fullstack Developer</h4>
                <div className="text-lg text-[#D4AF37] font-mono">I4 Technologies</div>
              </div>
            </div>
            <ul className="space-y-4 text-slate-600 dark:text-slate-400 text-sm leading-relaxed font-mono">
              <li className="flex items-start gap-3">
                <span className="text-[#D4AF37] mt-0.5">❯</span>
                <span>Developed modern business and web applications for clients across different industries.</span>
              </li>
              <li className="flex items-start gap-3">
                <span className="text-[#D4AF37] mt-0.5">❯</span>
                <span>Built responsive frontend interfaces and backend integrations.</span>
              </li>
              <li className="flex items-start gap-3">
                <span className="text-[#D4AF37] mt-0.5">❯</span>
                <span>Improved usability, maintainability, and performance of deployed applications.</span>
              </li>
            </ul>
          </div>
          
          <div className="p-8 border border-slate-200 dark:border-slate-800 bg-white/50 dark:bg-[#0A192F]/50 rounded-xl backdrop-blur-sm relative hover:border-slate-300 dark:hover:border-slate-700 transition-colors group">
            <h4 className="text-xl font-bold text-slate-900 dark:text-white mb-4">Education</h4>
            <div className="flex flex-col md:flex-row gap-6">
              <div className="flex items-center gap-3 bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-800 px-4 py-3 rounded-md text-sm font-mono text-slate-700 dark:text-slate-300"><span className="text-[#D4AF37]">🎓</span> M.Sc. Information Technology</div>
              <div className="flex items-center gap-3 bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-800 px-4 py-3 rounded-md text-sm font-mono text-slate-700 dark:text-slate-300"><span className="text-[#D4AF37]">🎓</span> B.Tech. Computer Science</div>
            </div>
          </div>
        </div>
      </section>
